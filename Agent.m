...
%                 dwellTimeAhead = obj.dwellTimeAhead(graph,horizon,'RHC-Periodic'); % 'RHC', 'fixed', 'random', 'variable'
        ...
        function dwellTime = dwellTimeAhead(obj, graph, horizon, controlMethod)
            ...
            elseif isequal(controlMethod,'RHC') | isequal(controlMethod,'RHC-Learn')
                currentTargetId = obj.residingTarget;
...
%             feasibleTargets
            ...
            if obj.learnMode & isequal(controlMethod,'RHC-Learn')
            ...
            if obj.learnMode & nextTargetId ~= currentTargetId & isequal(controlMethod,'RHC-Learn')
